...
def print_label_data(result):
    print("Resultado dos agrupamento \n")
    for data in result[0]:
        print("dado: {}".format(data[1]))
        print("grupo pertencente: {} \n".format(data[0]))
    print("Ultima posição dos centroids: \n {}".format(result[1]))

def create_centroids():
    centroids = []
    centroids.append([0, 0, 0, 0, 0, 0])
    centroids.append([0.5, 0, 0, 0, 0, 0])
    centroids.append([1, 0, 0, 0, 0, 0])
